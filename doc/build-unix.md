UNIX BUILD NOTES
====================
Some notes on how to build DudgX in Unix.

Note
---------------------
Always use absolute paths to configure and compile DudgX and the dependencies,
...
memory available when compiling DudgX. With 512MB of memory or less
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, DudgX should be built with a non-executable stack
