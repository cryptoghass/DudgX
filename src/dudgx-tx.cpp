...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("DudgX DudgX-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  DudgX-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded DudgX transaction") + "\n" +
                               "  DudgX-tx [options] -create [commands]   " + _("Create hex-encoded DudgX transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded DudgX transaction
