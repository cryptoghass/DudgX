...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* DudgX features */
        {"DudgX", "masternode", &masternode, true, true, false},
        {"DudgX", "listmasternodes", &listmasternodes, true, true, false},
        {"DudgX", "getmasternodecount", &getmasternodecount, true, true, false},
        {"DudgX", "masternodeconnect", &masternodeconnect, true, true, false},
        {"DudgX", "masternodecurrent", &masternodecurrent, true, true, false},
        {"DudgX", "masternodedebug", &masternodedebug, true, true, false},
        {"DudgX", "startmasternode", &startmasternode, true, true, false},
        {"DudgX", "createmasternodekey", &createmasternodekey, true, true, false},
        {"DudgX", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"DudgX", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"DudgX", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"DudgX", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"DudgX", "getmasternodescores", &getmasternodescores, true, true, false},
        {"DudgX", "mnbudget", &mnbudget, true, true, false},
        {"DudgX", "preparebudget", &preparebudget, true, true, false},
        {"DudgX", "submitbudget", &submitbudget, true, true, false},
        {"DudgX", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"DudgX", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"DudgX", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"DudgX", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"DudgX", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"DudgX", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"DudgX", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"DudgX", "checkbudgets", &checkbudgets, true, true, false},
        {"DudgX", "mnsync", &mnsync, true, true, false},
        {"DudgX", "spork", &spork, true, true, false},
        {"DudgX", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"DudgX", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use DudgXd, or the -server option to DudgX-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> DudgX-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:44772/\n";
}
