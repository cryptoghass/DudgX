...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DudgX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and DudgX: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About DudgX"), this);
    aboutAction->setStatusTip(tr("Show information about DudgX"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for DudgX"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DudgX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DudgX addresses"));
    ...
    openAction->setStatusTip(tr("Open a DudgX: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the DudgX help message to get a list with possible DudgX command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("DudgX client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DudgX network", "", count));
}
...
{
    QString strTitle = tr("DudgX"); // default title
