Contributing to DudgX
============================

The DudgX project operates an open contributor model where anyone is
...
The following applies to code changes to the DudgX project, and is not to be
confused with overall DudgX Network Protocol consensus changes.

Whether a pull request is merged into DudgX rests with the project merge
...
Patches that change DudgX consensus rules are considerably more involved than
...
Where a patch set proposes to change the DudgX consensus, it must have been
...
The project leader is the release manager for each DudgX release.
