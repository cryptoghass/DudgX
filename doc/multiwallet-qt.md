...
In order to support loading of multiple wallets in DudgX-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is DudgX.cpp.
...
Changes to DudgX.cpp
----------------------
DudgX.cpp is the entry point into DudgX-qt, and as such, will require some minor modifications to provide hooks for
