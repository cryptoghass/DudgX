...
/** Utility functions used by the DudgX Qt UI.
 */
namespace GUIUtil
{
...
// Render DudgX addresses in monospace font
...
// Parse "DudgX:" URI into recipient object, return true on successful parsing
